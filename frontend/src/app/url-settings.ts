...
export const resume_url = '/soumu/rirekisho/'
export const cv_url = '/public/shokumurirekisho/'
export const sc_url = '/public/studycourse/'
export const qu_url = '/public/qualifications'
